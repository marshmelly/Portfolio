         ...
         className="min-h-screen flex items-center justify-center py-3">
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/70 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
